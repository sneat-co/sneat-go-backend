...
type Scrum struct {
	...
	Metrics        []*models4teamus.TeamMetric `json:"metrics,omitempty" firestore:"metrics,omitempty"`
	TeamMetrics    []*MetricRecord             `json:"teamMetrics,omitempty" firestore:"teamMetrics,omitempty"`
}

var _ models4meetingus.MeetingInstance = (*Scrum)(nil)

// BaseMeeting returns base information on a api4meetingus
func (v *Scrum) BaseMeeting() *models4meetingus.Meeting {
	return &v.Meeting
}
