...
//)
//
//func SetWhitelistedDomains(ctx context.Context, r *http.Request, bot botsfw.BotSettings, api4debtus fbmbotapi.GraphAPI) (err error) {
...
//	}
//
//	if err = api4debtus.SetWhitelistedDomains(c, whitelistedDomainsMessage); err != nil {
//		return
//	}
//	return
//}
