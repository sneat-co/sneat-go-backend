...
func (AdminDalGae) DeleteAll(c context.Context, botCode, botChatID string) error {
	...
	//chatKey := gaehost.NewGaeTelegramChatStore(anybot.TheAppContext.GetBotChatEntityFactory("telegram")).NewBotChatKey(c, botCode, botChatID)
	...
	//} else {
	//	t.Delay = time.Second
	//	if _, err = taskqueue.Add(c, t, anybot.QUEUE_SUPPORT); err != nil {
