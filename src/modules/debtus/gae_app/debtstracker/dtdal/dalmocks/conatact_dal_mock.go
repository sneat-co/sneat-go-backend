...
//}
//
////CreateContact(c context.Context, userID int64, contactDetails models.ContactDetails) (contact models.DebtusSpaceContactEntry, user models.AppUser, err error)
////CreateContactWithinTransaction(c context.Context, user models.AppUser, contactUserID, counterpartyCounterpartyID int64, contactDetails models.ContactDetails, balanced money.Balanced) (contact models.DebtusSpaceContactEntry, err error)
////UpdateContact(c context.Context, contactID int64, values map[string]string) (contactEntity *models.ContactEntity, err error)
//
//func (mock *ContactDalMock) SaveContact(c context.Context, contact models.DebtusSpaceContactEntry) (err error) {
...
//}
//
//func (mock *ContactDalMock) GetContactsWithDebts(c context.Context, userID int64) (contacts []models.DebtusSpaceContactEntry, err error) {
//	return
//}
