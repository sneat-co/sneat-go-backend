...
func GetByID(ctx context.Context, getter dal.ReadSession, teamID, happeningID string, dto models4calendarium.HappeningDbo) (record dal.Record, err error) {
...
func GetForUpdate(ctx context.Context, tx dal.ReadwriteTransaction, teamID, happeningID string, dto models4calendarium.HappeningDbo) (record dal.Record, err error) {
