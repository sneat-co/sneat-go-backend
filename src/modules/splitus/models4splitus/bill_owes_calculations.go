...
func (entity *BillCommon) updateMemberOwes(members []*briefs4splitus.BillMemberBrief) (err error) {
...
func updateMemberOwesForEqualSplit(amountTotal decimal.Decimal64p2, creatorUserID string, members []*briefs4splitus.BillMemberBrief) {
...
func updateMemberOwesForSplitByPercentage(amountTotal decimal.Decimal64p2, creatorUserID string, members []*briefs4splitus.BillMemberBrief) {
	updateMemberOwesForSplitByShares(amountTotal, creatorUserID, members)
}

func updateMemberOwesForSplitByShares(amountTotal decimal.Decimal64p2, creatorUserID string, members []*briefs4splitus.BillMemberBrief) {
...
func fixTotal(amountTotal decimal.Decimal64p2, members []*briefs4splitus.BillMemberBrief) {
