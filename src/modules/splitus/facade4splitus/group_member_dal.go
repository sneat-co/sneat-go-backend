...
func (GroupMemberDalGae) CreateGroupMember(c context.Context, tx dal.ReadwriteTransaction, groupMemberData *models4splitus.GroupMemberData) (groupMember models4splitus.GroupMember, err error) {
...
func (GroupMemberDalGae) GetGroupMemberByID(c context.Context, tx dal.ReadSession, groupMemberID int64) (groupMember models4splitus.GroupMember, err error) {
