...
func TestRemoveMetrics(t *testing.T) {
	...
	//userContext := facade.NewUser("u1")
	//test := func(t *testing.T, request dto4spaceus.TeamMetricsRequest, expected int) {
	//	ctx := context.Background()
	//
	//	if err := RemoveMetrics(ctx, userContext, request); err != nil {
	//		t.Fatal(err)
	//	}
	//}
	//
	//t.Run("remove_first", func(t *testing.T) {
	//	request := dto4spaceus.TeamMetricsRequest{
	//		SpaceRequest: dto4spaceus.NewTeamRequest("space1"),
	//		Metrics:     []string{"m1"},
	//	}
	//	test(t, request, 4)
	//})
