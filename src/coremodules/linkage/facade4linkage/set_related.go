...
func SetRelated(
	...
	object dbo4linkage2.Relatable,
	objectRef dbo4linkage2.SpaceModuleItemRef,
	itemRef dbo4linkage2.SpaceModuleItemRef,
	rolesCommand dbo4linkage2.RelationshipItemRolesCommand,
) (
	...
	if objectWithRelated.Related == nil {
		objectWithRelated.Related = make(dbo4linkage2.RelatedByModuleID, 1)
	}
	getRelationships := func(ids []string) (relationships dbo4linkage2.RelationshipRoles) {
		relationships = make(dbo4linkage2.RelationshipRoles, len(ids))
		for _, r := range ids {
			relationships[r] = &dbo4linkage2.RelationshipRole{
