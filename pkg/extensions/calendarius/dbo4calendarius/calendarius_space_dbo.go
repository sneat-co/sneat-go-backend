...
type CalendariusSpaceDbo struct {
...
func (v *CalendariusSpaceDbo) Validate() error {
...
func (v *CalendariusSpaceDbo) GetRecurringHappeningBrief(id string) *CalendarHappeningBrief {
