...
func getHappeningContactRecords(ctx context.Context, tx dal.ReadwriteTransaction, request *dto4calendarius.HappeningContactsRequest, params *dal4calendarius.HappeningWorkerParams) (contacts []dal4contactus.ContactEntry, err error) {
